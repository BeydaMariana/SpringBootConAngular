...
import com.bolsadeideas.spring.backend.apirest.models.services.IUploadFileServices;
...
public class ClienteRestController {
	...
	@GetMapping("/clientes/page/{page}")//Aquí se implementa la paginación
	...
	public ResponseEntity<?> create(@Valid @RequestBody Cliente cliente, BindingResult result) {
		...
		if(result.hasErrors()) { //Valida si viene un error en la validación establecida
	...
	public ResponseEntity<?> update(@Valid @RequestBody Cliente cliente, BindingResult result, @PathVariable Long id) {
		...
		//De aquí se empieza la validación de los datos como en el front pero en el backend
		if(result.hasErrors()) { //Valida si viene un error en la validación establecida
